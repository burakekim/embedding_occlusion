...
--crop_size 256 --use_sampler --use_lr_scheduler --return_modality 'all'

# modality bencmark

python main_train.py --exp_name 61__regularizer_all --batch_size 16 --max_epochs 20 \
--crop_size 256 --use_sampler --use_lr_scheduler --return_modality 'all' --test_batch_size 1
...
--crop_size 256 --use_sampler --use_lr_scheduler --return_modality 's1'  

python main_train.py --exp_name 57__regularizer_s2_no_logs --batch_size 16 --max_epochs 100 \
--crop_size 256 --use_sampler --use_lr_scheduler --return_modality 's2'  

python main_train.py --exp_name 57__regularizer_esa_wc_no_logs --batch_size 16 --max_epochs 100 \
--crop_size 256 --use_sampler --use_lr_scheduler --return_modality 'esa_wc'  
...
--crop_size 256 --use_sampler --use_lr_scheduler --return_modality 'all' --occlusion_type "zero"

python main_train.py --exp_name 61__regularizer_one --batch_size 16 --max_epochs 10 --test_batch_size 1 \
--crop_size 256 --use_sampler --use_lr_scheduler --return_modality 'all' --occlusion_type "one"

python main_train.py --exp_name 61__regularizer_random --batch_size 16 --max_epochs 10 --test_batch_size 1 \
--crop_size 256 --use_sampler --use_lr_scheduler --return_modality 'all' --occlusion_type "random"

python main_train.py --exp_name 61__regularizer_gaussian --batch_size 16 --max_epochs 10 --test_batch_size 1 \
--crop_size 256 --use_sampler --use_lr_scheduler --return_modality 'all' --occlusion_type "gaussian"
...
--crop_size 256 --use_sampler --use_lr_scheduler --return_modality 'all'  --checkpoint_path "./logs/57__regularizer/57__regularizer_16_256epoch=51-val_loss=0.02.ckpt"
